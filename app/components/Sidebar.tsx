      ...
      <div className="p-4 border-t border-slate-800">
        <div className="flex items-center gap-3 bg-slate-800/50 p-3 rounded-xl border border-slate-700/50">
          ...
          <div className="overflow-hidden">
            <p className="text-sm font-bold truncate">Alice Locataire</p>
            <p className="text-[10px] text-blue-400 font-bold uppercase">LOCATAIRE</p>
          </div>
        </div>
        <button className="w-full mt-3 flex items-center justify-center gap-2 text-xs font-bold text-slate-500 hover:text-white transition-colors py-2">
